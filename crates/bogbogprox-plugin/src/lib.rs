...
use bindings::exports::bogbogprox::plugin::hooks;
use bindings::bogbogprox::plugin::host::Host as HostCap;
use bindings::Plugin;
...
impl bindings::bogbogprox::plugin::types::Host for State {}

impl HostCap for State {
    fn log(&mut self, level: String, msg: String) {
        match level.as_str() {
            "error" => tracing::error!(target: "bogbogprox_plugin", "[{}] {msg}", self.plugin),
            "warn" => tracing::warn!(target: "bogbogprox_plugin", "[{}] {msg}", self.plugin),
            _ => tracing::info!(target: "bogbogprox_plugin", "[{}] {msg}", self.plugin),
        }
    }
}
